...
public class LoginWindow extends javax.swing.JFrame {
    ...
    public LoginWindow() {
        ...
        File file_in_library_ms_dir = new File(fw.getDefaultDirectory() + "\\SKSCLibrary\\config.dat");
        File library_ms_dir = new File(fw.getDefaultDirectory() + "\\SKSCLibrary");
    ...
    private void login_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_login_btnActionPerformed
        ...
        String line, mysql_uname = "root", mysql_pass = "", mysql_server = "localhost", mysql_db = "sksc_library_ms";

        try {
            base64.decode_from_base64();
            File temp_config = new File(fw.getDefaultDirectory() + "\\SKSCLibrary\\config_temp.dat");
