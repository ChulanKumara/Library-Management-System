...
public class Base64Converter {
    ...
    public void encode_to_base64() {
        try {
            encode("config.dat", fw.getDefaultDirectory() + "\\SKSCLibrary\\config.dat", IS_CHUNKED);
        } catch (Exception ec) {
    ...
    public void decode_from_base64() {
        try {
            decode(fw.getDefaultDirectory() + "\\SKSCLibrary\\config.dat", fw.getDefaultDirectory() + "\\SKSCLibrary\\config_temp.dat");
        } catch (Exception ec) {
